...
foreach ($dischi as &$disco) {
    $disco["likeValue"] = false;
    $disco["likeIcon"] = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-through-heart" viewBox="0 0 16 16">
...
if (isset($_POST["likeValue"]) && $_POST["likeValue"] === true) {
    
}
// var_dump($dischi);

// aggiungo resp data prima della codifica in json
$resp_data = [
    "results" => $dischi,
    "success" => true,
];
...
// ----------------------------------------------------------------------------------
// file_put_contents("dischi.json", json_decode($dischi));

$json_list = json_encode($resp_data);
// var_dump($json_list);

header("Content-Type: application/json");

echo $json_list; // Stampa la stringa JSON, non l'array
